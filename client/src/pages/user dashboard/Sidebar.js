      ...
      <ul className="list-none m-0 p-0">
        <li>
          <button
            ...
            className={`flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-200 transition-colors w-full text-left ${isActive(`/user-dashboard/user-profile/${userInfo._id}`)}`}
          >
            <CgProfile size={24} />
            <span>Profile</span>
          </button>
        ...
        <li>
          <button
            onClick={() => navigateTo(`/user-dashboard/user-review/:boardingHouseId`)}
            className={`flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-200 transition-colors w-full text-left ${isActive(`/user-dashboard/user-review/:boardingHouseId`)}`}
          >
        ...
        <li>
          <button
            onClick={() => navigateTo("/")}
            className={`flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-200 transition-colors w-full text-left ${isActive("/")}`}
          >
            <BiHome size={24} />
            <span>Home</span>
          </button>
