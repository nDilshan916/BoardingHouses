  ...
  return (
    <div className="w-70 h-full bg-gray-50 p-4 shadow">
      <ul className="list-none m-0 p-0">
        ...
        <li>
          <button
            onClick={() => navigateTo("/holder-dashboard/chat")}
            className={`flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-200 transition-colors w-full text-left ${isActive("/holder-dashboard/chat")}`}
          >
