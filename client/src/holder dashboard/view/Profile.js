...
function Profile({ holderId }) {
  ...
  return (
    <div className="max-w-2xl ml-10 mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex justify-center mb-4">
        <label className="bg-blue-500 py-2 px-4 text-white rounded-md cursor-pointer">
        ...
        <form className="space-y-4">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-auto bg-blue-500 px-4 py-2 rounded-lg  text-white hover:bg-blue-600 focus:outline-none focus:bg-blue-600 "
            >
              Update Profile
            </button>
          </div>
